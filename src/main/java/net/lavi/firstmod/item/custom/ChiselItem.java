package net.lavi.firstmod.item.custom;
...
public class ChiselItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        if (Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("tooltip.firstmod.chisel.shift_down"));
            tooltip.add(Text.translatable("tooltip.firstmod.chisel.shift_down.2"));
        }   else {
            tooltip.add(Text.translatable("tooltip.firstmod.chisel"));
        }
